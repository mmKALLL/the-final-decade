...
export const yearlyContracts: YearlyContract[] = [
  ...
  },
  {
    ...
    year: 2025,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '🔧 -40, income -5, unity -1', 'jp-FI': '🔧 -40、収入 -5、公共団結 -1' },
  ...
  },
  {
    ...
    year: 2025,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '🧪 -30, unity -2', 'jp-FI': '🧪 -30、公共団結 -2' },
  ...
  },
  {
    ...
    year: 2026,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '🔧 -100, unity -2', 'jp-FI': '🔧 -100、公共団結 -2' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [],
    requirements: [],
    costs: [
  ...
  // === 2027 ===
  {
    ...
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '💬 -80, unity -1', 'jp-FI': '💬 -80、公共団結 -1' },
    requirementDescription: { 'en-US': 'unity >= 1, Trust >= 120', 'jp-FI': '公共団結 >= 1、信頼 >= 120' },
    onSuccess: [],
    requirements: [
      { paramEffected: 'publicUnity', amount: 1 },
  ...
  },
  {
    ...
    year: 2027,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '🔧 -180, unity -3', 'jp-FI': '🔧 -180、公共団結 -3' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [],
    requirements: [],
    costs: [
