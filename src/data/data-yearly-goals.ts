...
export const yearlyContracts: YearlyContract[] = [
  // === 2025 ===
  {
    ...
    costDescription: { 'en-US': '💬 -30, income -10', 'jp-FI': '💬 -30、受動的収入 -10' },
  ...
  },
  {
    ...
    year: 2026,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'income -20, 🔧 -60', 'jp-FI': '受動的収入 -20、🔧 -60' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [],
    requirements: [],
    costs: [
  ...
  // === 2027 ===
  {
    ...
    year: 2027,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '💬 -40, ASI Outcome -40', 'jp-FI': '💬 -40、ASIの結果 -40' },
  ...
  },
  {
    ...
    year: 2027,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '🔧 -80, Public unity -2', 'jp-FI': '🔧 -80、公共団結 -2' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [],
    requirements: [],
    costs: [
  ...
  },
  {
    ...
    year: 2028,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': '🧪 -320', 'jp-FI': '🧪 -320' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [],
    requirements: [],
