...
export const yearlyContracts: YearlyContract[] = [
...

  {
    ...
    costs: [{ paramEffected: 'publicUnity', amount: -1 }],
  },
  {
  ...
  },
  {
    ...
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
    costs: [{ paramEffected: 'rp', amount: -40 }],
  },
  ...
  // === 2027 ===
  {
    ...
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [{ paramEffected: 'publicUnity', amount: 2 }],
  ...
  },
  {
    ...
    requirements: [],
    costs: [
      { paramEffected: 'money', amount: -1000 },
