...
export const yearlyContracts: YearlyContract[] = [
...

  {
    ...
    year: 2025,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'EP -30', 'jp-FI': 'EP -30' },
...

  {
    ...
    year: 2026,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'Public unity -1', 'jp-FI': '公共団結 -1' },
  ...
  },
  {
    ...
    year: 2026,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'Passive income -20, EP -40', 'jp-FI': '受動的収入 -20、EP -40' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
    costs: [
  ...
  },
  {
    ...
    year: 2026,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'RP -40', 'jp-FI': 'RP -40' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
  ...
  // === 2027 ===
  {
    ...
    year: 2027,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'SP -50', 'jp-FI': 'SP -50' },
    requirementDescription: { 'en-US': 'Public unity >= 2', 'jp-FI': '公共団結 >= 2' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
  ...
  },
  {
    ...
    year: 2027,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'EP -40, Public unity -1', 'jp-FI': 'EP -40、公共団結 -1' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
    costs: [
  ...
  },
  {
    ...
    year: 2027,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'RP -60', 'jp-FI': 'RP -60' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
  ...
  // === 2028 ===
  {
    ...
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'Public unity -1', 'jp-FI': '公共団結 -1' },
    requirementDescription: { 'en-US': 'Trust >= 120, Influence >= 180', 'jp-FI': '信頼 >= 120、影響力 >= 180' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [
  ...
  },
  {
    ...
    year: 2028,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'Money -1000, EP -80', 'jp-FI': 'お金 -1000、EP -80' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
    costs: [
  ...
  },
  {
    ...
    year: 2028,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'RP -140', 'jp-FI': 'RP -140' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '(なし)' },
    onSuccess: [{ paramEffected: 'breakthroughSelection', amount: 300 }],
    requirements: [],
