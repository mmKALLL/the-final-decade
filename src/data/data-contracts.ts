...
export const yearlyContracts: YearlyContract[] = [
...

  {
    ...
    year: 2025,
    successDescription: { 'en-US': 'Epic breakthrough', 'jp-FI': '壮絶な突破' },
    costDescription: { 'en-US': 'EP -30', 'jp-FI': '信頼 -10' },
    requirementDescription: { 'en-US': 'Trust >= 110', 'jp-FI': 'お金 >= 50' },
    onSuccess: [
...

  {
    ...
    year: 2026,
    successDescription: {
      'en-US': 'Trust +30, Public unity +2',
      'jp-FI': '信頼 +30、アラインメント受け入れ -2',
    },
    costDescription: { 'en-US': 'Public unity -1', 'jp-FI': '影響力 -15' },
    requirementDescription: { 'en-US': 'Influence >= 140', 'jp-FI': 'RP >= 50' },
    onSuccess: [
  ...
  },
  {
    ...
    costDescription: { 'en-US': 'Passive income -20, EP -40', 'jp-FI': 'SP -20' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': 'EP >= 60' },
    onSuccess: [
  ...
  },
  {
    ...
    costDescription: { 'en-US': 'RP -40', 'jp-FI': 'SP -10' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '信頼 >= 80' },
  ...
  // === 2027 ===
  {
    ...
    year: 2027,
    successDescription: {
      'en-US': 'Money +50, Public unity -3',
      'jp-FI': 'お金 +50、アラインメント受け入れ -3',
    },
    costDescription: { 'en-US': 'SP -50', 'jp-FI': '信頼 -20' },
    requirementDescription: { 'en-US': 'Public unity >= 2', 'jp-FI': 'お金 >= 200' },
    onSuccess: [
  ...
  },
  {
    ...
    costDescription: { 'en-US': 'EP -40, Public unity -1', 'jp-FI': 'アラインメントフォーカス -4' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': 'SP >= 100' },
    onSuccess: [
      { paramEffected: 'money', amount: 80 },
      { paramEffected: 'trust', amount: -50 },
    ],
    requirements: [{ paramEffected: 'sp', amount: 100 }],
    costs: [{ paramEffected: 'publicUnity', amount: -4 }],
  },
  {
    name: { 'en-US': 'Cheap Superposition Analysis', 'jp-FI': 'AIによる大量解雇' },
    rarity: 'epic',
    year: 2027,
    successDescription: { 'en-US': 'Money +60, Trust -30', 'jp-FI': 'お金 +60、信頼 -30' },
    costDescription: { 'en-US': 'RP -60', 'jp-FI': 'SP -25' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '影響力 >= 100' },
    onSuccess: [
  ...
  // === 2028 ===
  {
    ...
    rarity: 'epic',
    year: 2028,
    successDescription: { 'en-US': 'Public unity +5, Trust -30', 'jp-FI': 'アラインメントフォーカス +5、信頼 -30' },
    costDescription: { 'en-US': 'Public unity -1', 'jp-FI': 'お金 -50' },
    requirementDescription: { 'en-US': 'Trust >= 120, Influence >= 180', 'jp-FI': '影響力 >= 250' },
    onSuccess: [
  ...
  {
    name: { 'en-US': 'Autonomous Nation Shutdown', 'jp-FI': '自律国家の独立宣言' },
    rarity: 'epic',
    year: 2028,
    successDescription: { 'en-US': 'Influence +40, Trust -10', 'jp-FI': '影響力 +40、信頼 -10' },
    costDescription: { 'en-US': 'Money -1000, EP -80', 'jp-FI': 'SP -20' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '影響力 >= 150' },
    onSuccess: [
  ...
  {
    name: { 'en-US': 'Prosaic Alignment', 'jp-FI': 'AGI安全条約' },
    rarity: 'epic',
    year: 2028,
    successDescription: {
      'en-US': 'Trust +50, Public unity +3',
      'jp-FI': '信頼 +50、アラインメント受け入れ +3',
    },
    costDescription: { 'en-US': 'RP -140', 'jp-FI': '影響力 -30' },
    requirementDescription: { 'en-US': '(none)', 'jp-FI': '信頼 >= 200' },
    onSuccess: [
      { paramEffected: 'trust', amount: 50 },
      { paramEffected: 'publicUnity', amount: 3 },
    ],
  ...
  // === 2029 ===
  {
    name: { 'en-US': 'ASI Deployment', 'jp-FI': '汎用的人工知能のデプロイ' },
    rarity: 'epic',
    year: 2029,
